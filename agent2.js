...
async function main() {
  ...
  while (true) {
    ...
    if (parsedContent.step === "TOOL") {
      ...
      const responceFormTool = await TOOL_MAP[toolToCall](parsedContent.input);
      console.log(
      ...
      messages.push({
        role: "developer",
        content: JSON.stringify({ step: "OBSERVE", content: responceFormTool }),
      });
      continue;
    }
